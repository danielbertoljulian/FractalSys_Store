...
export default function HeroStore() {
  return (
    <section className="relative min-h-[70vh] flex flex-col items-center justify-start overflow-hidden pt-28 pb-12">
      ...
      <div className="relative w-full max-w-[1400px] mx-auto px-4 md:px-10 mb-2 flex items-center justify-center">
        ...
        <div className="absolute inset-0 flex items-center justify-center blur-[1px] scale-105 pointer-events-none">
          <Image
            ...
            width={1200}
            height={600}
            className="object-contain max-h-[78vh] w-auto opacity-90"
            style={{ 
      ...
      <div className={`relative z-10 mt-32 md:mt-44 flex flex-col items-center justify-center px-4 text-center max-w-5xl mx-auto ${orbitron.className}`}>
